...
- 🛠️ Feature rich group moderation
- 🔍 Discover and join public groups
- 🌙 Dark mode
- 🎨 Material You design
- 😋 Custom emotes and stickers
- 🌌 Spaces
- 🔄 Compatible with other Matrix apps
...
[Yomi](https://yomi.92li.uk)

## 🗂️ License

Yomi is released under the GNU General Public License v3.0 (GPLv3).
